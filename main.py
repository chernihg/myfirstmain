...
if __name__ == "__main__":
    ...
    with open("/Users/dargelsergey/Cryptocurrency/Code/binance-withdraw-ccxt-main/wallets.txt", "r") as f:
    ...
    # api_keys of binance
    API_KEY = "oAjUN1jpLO40xXzHAaghq77rpY7K1uReftxvyJ04rJd4ABSJ7Nlku2XUrPEz63Gi"
    API_SECRET = "BbKE63aEYBacIsesxsaXRCOQDBFRotDq8XsoDNCIRSwfLskpQpqnfWyznfL5viuf"
    ...
    for wallet in wallets_list:
        address = web3.toChecksumAddress(wallet)
        amount_to_withdrawal = round(random.uniform(0.02, 0.021), 6) # amount from ... to ...
